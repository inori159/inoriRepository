...
<!--文件尾开始-->
		...
		<tr>
         ...
         <c:forEach var="orderline" items="${orderlines}">
         	<tr>
				<td class=tablebody2 valign=middle align=center width="">${orderline.order.id}</td>
				...
				<td class=tablebody2 valign=middle align=left width="">小计：￥${(orderline.num)*(orderline.book.price)}</td>
			</tr>   
         </c:forEach>
		...
		<tr>
			...
			<td class=tablebody1 valign=middle align=left width="">合计：<font color="#ff0000"><b>￥${orderlines[0].order.cost}</b></font></td>
		</tr>
		        </table>
		</form>
		<br>
