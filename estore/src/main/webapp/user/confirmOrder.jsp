...
<!--文件体开始-->
		...
		<form name="order" method="post" action="Confirm">
		...
		<tr>
			<td class="tablebody2" align="right"><b>编码</b>：</td>
...
<!--文件尾开始-->
		...
		<tr>
         ...
         <c:forEach var="line" items="${shoppingCart.getLines()}">
         	<tr>
				<td class=tablebody2 valign=middle align=center width="">${line.value.book.id}</td>
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="" target="_blank">${line.value.book.name}</a></td>
				...
				<td class=tablebody2 valign=middle align=left width="">小计：￥${line.value.book.price}</td>
			</tr>   
         </c:forEach>
		...
		<tr>
			...
			<td class=tablebody1 valign=middle align=left width="">合计：<font color="#ff0000"><b>￥${shoppingCart.getCost()}</b></font></td>
		</tr>
		        </table>
