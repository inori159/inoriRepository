...
<!--文件体开始-->
        ...
        <c:forEach var="order" items="${orderList}" varStatus="status" step="1">
        	<tr>
				...
				<input type="button" value="删除" onclick="javascript:window.location='OrderRemove?id=${order.id}';">&nbsp;
				<input type="button" value="明细" onclick="javascript:window.location='OrderInfo?id=${order.id}';">
				</td>
			</tr>
        </c:forEach>
