...
<!--文件体开始-->
		...
		<tr>
        	...
        	<c:forEach  var="line" items="${shoppingCart.getLines()}">
					 <tr>
						...
						<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;${line.value.book.price}</td>
						<td class=tablebody1 valign=middle align=center width="">
						<input type="button" value="取消" onclick="javascript:window.location='DelOrderline?bookid=${line.value.book.id}';"> 
		...
		<tr>
			...
			<td class=tablebody1 valign=middle align=left width="">&nbsp;&nbsp;<font color="#ff0000"><b>${shoppingCart.getCost()}</b></font></td>
